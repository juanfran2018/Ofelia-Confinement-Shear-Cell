...
, ![v_\ell = 20](https://render.githubusercontent.com/render/math?math=v_%5Cell%20%3D%200.02)
 ![v_\ell = 0.02\ \mu m/s]. When selecting speed, the following equation will be easier to use (with ![$v_\ell$](https://render.githubusercontent.com/render/math?math=%24v_%5Cell%24)
 in mm/min):
