...
, $y_{ij} = b_{ij} + \beta_{0} + \beta_{1}$. When selecting speed, the following equation will be easier to use (with ![$v_\ell$](https://render.githubusercontent.com/render/math?math=%24v_%5Cell%24)
 in mm/min):
